...
export default function CreatePost() {
 ...
 <option value='uncategorized'>Choose a category</option>
  ...
  <option value='naturallanguage'>Natural Language Processing (NLP)</option>
  <option value='csesubjects'>Computer Science Subjects</option>
  ...
  <option value='adminthought'>Admin Talks</option>
